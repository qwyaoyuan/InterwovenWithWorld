...
namespace DialogueDataFileEditor
{
    public partial class NewProjectForm : Form
    {
        ...
        /// 上次选择的路径
        /// </summary>
        public static string lastPath = @"E:\MyProject\Unity\InterwovenWithWorld\InterwovenWithWorld\编辑工具\DialogueData";
        ...
        private void Button_OK_Click(object sender, EventArgs e)
        {
            ...
            newFilePath = TextBox_Folder.Text + "\\" + TextBox_ProjectName.Text + ".DialogueEditor";
